          ...
          : (
            <>
              {!currLocationClick
                ? (
                  <>
                    <img src={setting.setting && setting.setting.web_settings.web_logo } alt='location'></img>
                    ...
                    <button whileTap={{ scale: 0.6 }} onClick={handleCurrentLocationClick} disabled={isInputFields} style={isInputFields ? { opacity: "0.5" } : null}>
                      <BiCurrentLocation className='mx-3' />Use my Current location</button>
                ...
                : (
                  <>
                    ...
                    <p className='map-content-p'><b>Address : </b>{isAddressLoading ? "...." : localLocation.formatted_address}</p>
                    {errorMsg === "" ? (
                      <div className='map-content'>
                        <button whileTap={{ scale: 0.6 }} type='button' className='btn-confirm-location' onClick={confirmCurrentLocation} disabled={localLocation.formatted_address === ''}>Confirm</button>
                      </div>
                    ) : null}
                  </>
                )}
